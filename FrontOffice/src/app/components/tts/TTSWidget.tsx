...
import { Volume2, Square, ChevronUp } from 'lucide-react';
...
export function TTSWidget() {
  ...
  return (
    ...
    >
      ...
      {/* Menu contextuel — s'ouvre au-dessus du bouton */}
      {menuOpen && (
        <div className="absolute bottom-14 right-0 bg-white border border-slate-200 rounded-xl shadow-xl w-52 overflow-hidden">
          {/* En-tête */}
